    ...
    <div key={note.id}>
      <div
        ...
        <img
          ...
          height={1}
          width={2}
          className={` hover:cursor-pointer mx-2 w-[1rem]  h-[1rem] hover:scale-110 transition-transform duration-200 rounded-[40%] 
            ${
              props.theme === "light"
                ? "bg-slate-300 "
  ...
  return (
    <section className="flex flex-col justify-center text-center">
      <div className="flex flex-row pb-6 px-5 justify-center">
        <h3 className="text-4xl mr-3">Notes</h3>
        <img
